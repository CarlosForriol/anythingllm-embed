...
const markdown = markdownIt({
  ...
  highlight: function (code, lang) {
    ...
    if (lang && hljs.getLanguage(lang)) {
      try {
        return (
          `<div class="allm-w-full allm-rounded-lg allm-bg-lex-code allm-font-mono allm-text-sm allm-text-lex-code-ink allm-mb-4 allm-relative">
            <div class="allm-absolute allm-top-0 allm-left-0 allm-right-0 allm-flex allm-items-center allm-justify-between allm-px-4 allm-py-1 allm-text-xs allm-font-sans allm-bg-lex-code-header allm-rounded-t-lg">
              <span class="allm-text-xs allm-text-lex-code-ink-muted allm-font-medium">${lang}</span>
              <button data-code-snippet data-code="code-${uuid}" class="allm-border-none allm-min-w-[52px] allm-h-[22px] allm-flex allm-items-center allm-justify-center allm-gap-x-1 allm-bg-lex-code-btn allm-text-lex-code-ink-muted hover:allm-text-lex-code-btn-ink-hover hover:allm-bg-lex-code-btn-hover allm-px-1.5 allm-rounded allm-transition-colors allm-cursor-pointer">
    ...
    return (
      `<div class="allm-w-full allm-rounded-lg allm-bg-lex-code allm-font-mono allm-text-sm allm-text-lex-code-ink allm-mb-4 allm-relative">
        <div class="allm-absolute allm-top-0 allm-left-0 allm-right-0 allm-flex allm-items-center allm-justify-between allm-px-4 allm-py-1 allm-text-xs allm-font-sans allm-bg-lex-code-header allm-rounded-t-lg">
          <span class="allm-text-xs allm-text-lex-code-ink-muted allm-font-medium">plaintext</span>
          <button data-code-snippet data-code="code-${uuid}" class="allm-border-none allm-min-w-[52px] allm-h-[22px] allm-flex allm-items-center allm-justify-center allm-gap-x-1 allm-bg-lex-code-btn allm-text-lex-code-ink-muted hover:allm-text-lex-code-btn-ink-hover hover:allm-bg-lex-code-btn-hover allm-px-1.5 allm-rounded allm-transition-colors allm-cursor-pointer">
            <svg class="allm-h-3 allm-w-3" fill="none" height="24" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="24"><path d="M8 17.929H6c-1.105 0-2-.912-2-2.036V5.036C4 3.912 4.895 3 6 3h8c1.105 0 2 .912 2 2.036v1.866m-6 .17h8c1.105 0 2 .91 2 2.035v10.857C20 21.088 19.105 22 18 22h-8c-1.105 0-2-.911-2-2.036V9.107c0-1.124.895-2.036 2-2.036z"/></svg>
            <span class="allm-text-xs">Copy</span>
          </button>
